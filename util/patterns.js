...
const pathMap = {
    ...
    1: { 1:'R', 2:4, 4:3, 40:11 },
    2: { 4:4, 40:12, 6:3, 7:'R' },
    3: { 1:4, 2:12, 4:11, 94:1, 96:1 },
    4: { 4:12, 6:11, 7:3, 92:1, 94:2 },
    5: { 1:6, 10:7, 3:16, 4:'G', 40:'B' },
    6: { 1:7, 2:9, 20:14, 3:16, 4:13, 5:'G', 7:5 },
    7: { 2:10, 3:14, 5:13, 6:'G', 7:6 },
    8: { 4:18, 5:23, 6:10, 60:14 },
    9: { 1:10, 2:14, 4:16, 6:13, 7:'G', 92:6, 93:7, 96:28 },
    10: { 5:17, 6:14, 7:9, 70:'G', 93:'O', 96:8 },
    11: { 1:12, 3:21, 94:3, 940:1, 95:'R', 96:4 },
    12: { 5:21, 7:11, 92:3, 93:'R', 94:4, 940:2 },
    13: { 1:14, 10:30, 93:'G', 94:6, 95:7, 96:9, 960:28 },
    14: { 1:30, 7:13, 92:7, 94:28, 95:'O', 96:10, 960:8 },
    15: { 1:16, 2:31, 10:17, 100:18, 4:22, 5:'B' },
    16: { 1:17, 10:18, 4:31, 7:15, 92:'G', 94:9, 95:28 },
    17: { 1:18, 2:25, 6:31, 7:16, 70:15, 95:10 },
    18: { 7:17, 70:16, 700:15, 94:8 },
    19: { 1:20, 2:'Y', 3:27, 4:26 },
    20: { 4:'Y', 40:27, 5:26, 6:25, 7:19 },
    21: { 1:'B', 10:22, 4:29, 93:11, 94:'R', 95:12 },
        ...
        for (let li=0; li<lines.length; ++li) {
            ...
            while (i < parts[2].length) {
                ...
                if (pathMap[lastPoint][dir]) {
                    ...
                    logger.warn('Invalid path for valid pattern:' + parts[0] + ' from ' + pattern)
                    return null
                }
                ++i
            }
